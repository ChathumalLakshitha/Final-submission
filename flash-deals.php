...
// Fetch all flash deals products from database
try {
...
<head>
    ...
    <title>Flash Deals - Paws & Clows</title>
</head>
<body>
    <!-- Navigation Bar -->
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Flash Deals</h2>
                <p class="text-center">Don't miss out on these amazing limited-time offers! Act fast before they're gone!</p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <?php if (empty($flash_deals)): ?>
                <div class="col-12 text-center">
                    <p>No flash deals available at the moment. Please check back later!</p>
                </div>
            <?php else: ?>
